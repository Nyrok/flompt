...
Cette phase d'`analyse` était une attente obligatoire : inférence Groq sur un modèle 12B, tournant avant que le vrai travail commence. Un bon jour, ça ajoutait environ une seconde. Un mauvais jour (cold start, rate limit, latence réseau), trois à cinq secondes.
